...
while 1:   
    ...
    availableRAM = int(consultaSNMP(comunidad, hostName,'1.3.6.1.4.1.2021.4.6.0'))
    ...
    usedRAM = totalRAM - availableRAM - sharedRAM - buffRAM - cacheRAM
    ...
    valor = "N:" + str(carga_CPU) + ':' + str(round(cargaRAM, 2)) + ':' + str(traficoEntrada) + ':' + str(traficoSalida)
